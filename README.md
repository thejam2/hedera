...
토큰화를 제공하는 퍼블릭 및 프라이빗 블록체인은 값비싼 수수료 또는 선행 인프라 비용, 느린 트랜잭션 속도, 거버넌스 관리의 복잡성 및 규제 장애물의 부담을 안고 있습니다.

Hedera 토큰 서비스를 사용하면 공용 Hedera 네트워크에서 네이티브 대체 가능 및 대체 불가능 토큰을 구성, 관리 및 전송할 수 있습니다.

Hedera 토큰 서비스는 매우 높은 처리량, 낮은 수수료 및 규정 준수 구성을 제공합니다.

아토믹 스왑 및 로열티에 대한 API 호출과 함께 온체인 프로그래밍 가능성도 있으며 보다 복잡한 프로그래밍을 위해 Hedera 스마트 계약 서비스에 통합됩니다.
